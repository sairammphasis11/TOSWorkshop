...
/*
Implementing the Producer and consumer class
Using the synchronized block to synchronize the intake and outake

 */

@SuppressWarnings("InfiniteLoopStatement")
//Processor has the synchronized method to manage the intake and outake
...
//class appprocessor is used to process consume and produce request
class AppProcessor {
